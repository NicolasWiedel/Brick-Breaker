package com.jga.screen.loading;
...
public abstract class LoadingScreenBase extends ScreenAdapter {
    ...
    private static final float DEFAULT_PROGRESS_BAR_HEIGHT = 30f;
    ...
    private void draw(){
        ...
        float progressBatY = (hudHeight - progressBarHeight) / 2f;
